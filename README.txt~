...
les deux joueurs sont kenny et cartman, chacun a son role de jouer, s'il essaye d'effectuer
un mouvement impossible, il garde son tour jusqu'a qu'il reussisse a se deplacer.

apart l'imppossibilte de se deplacer, tout les mouvements alternent les tours.
...
quand le joueur est sur une rampe sud, il ne peut pas aller au nord, si la case sur laquelle 
il devrait atterir ne contient pas ni de rampe ni de block plein.
...
quand un joueur est sur le téléporteur l'autre joueur se téléporte à sa case départ respective . s'il reussi a emprunter le passage secret, dans ce cas, il peut jouir du privilège des étoiles secrète. 
